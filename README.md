...
This dataset is used to train and evaluate the [kwyk](https://github.com/neuronets/kwyk) network. We are publishing in the form of a [datalad](https://www.datalad.org/) dataset.
...
Accessing data is explained in the following steps,
